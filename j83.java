...
public class j83 implements Serializable{
    ...
    public j83(int rank, String song, int lastWeek,String imagesrc, String artistsrc, String artist){
        super();
        this.rank = rank;
        this.song= song;
    ...
    public j83(int rank, String song, int lastWeek,String imagesrc, String artist){
        super();
        this.rank = rank;
        this.song= song;
        this.lastWeek= lastWeek;
