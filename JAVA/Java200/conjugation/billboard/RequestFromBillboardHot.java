...
public class RequestFromBillboardHot{   //RequesBillboardHot
    ...
    public synchronized void getBillboardData(String msg){
        ...
        for(int i=0;i<htmls.size();i++){
            ...
            if(ss.contains(msg)){
                ...
                Billboard board = new Billboard(toInt(rank),replace(song),toInt(__toStr(lastWeek)),imageurl,artisturl,artist);
